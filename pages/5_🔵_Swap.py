...
# Structure
st.set_page_config(page_title='Swap - Near Megadashboard', page_icon=':chart_with_upwards_trend:', layout='wide')
st.title('🔵 Swap')
...
fig = px.density_heatmap(df, x='HOUR', y='Day Name', z='Swaps Count', histfunc='avg', title='Swaps Count Heat map, Days of Week vs. Hours of Day', nbinsx=24)
...
fig = px.density_heatmap(df, x='HOUR', y='Day Name', z='Swaps Volume', histfunc='avg', title='Swaps Volume Heat map, Days of Week vs. Hours of Day', nbinsx=24)
...
fig = px.density_heatmap(df, x='Day', y='Hour', z='Swaps Count', histfunc='avg', title='Swaps Count Heat map, Days of Month vs. Hours of Day', nbinsx=24)
...
fig = px.density_heatmap(df, x='Day', y='Hour', z='Swaps Volume', histfunc='avg', title='Swaps Volume Heat map, Days of Month vs. Hours of Day', nbinsx=24)
