...
df = Tokens
fig = sp.make_subplots(specs=[[{'secondary_y': True}]])
fig.add_trace(go.Bar(x=df['Token'], y=df['Buying Volume'], name='Total Buying Volume'), secondary_y=False, barmode='group')
fig.add_trace(go.Bar(x=df['Token'], y=df['Selling Volume'], name='Total Selling Volume'), secondary_y=True, barmode='group')
