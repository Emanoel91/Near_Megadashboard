...
fig.add_trace(go.area(x=df['Date'], y=df['Senders Count'], name='Senders'), secondary_y=False)
fig.add_trace(go.area(x=df['Date'], y=df['Receivers Count'], name='Receivers'), secondary_y=True)
