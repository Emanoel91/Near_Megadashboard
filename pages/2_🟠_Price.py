...
fig = px.line(df, x='Date', y='Maximum', title='NEAR Price per Day', log_y=False)
fig = px.line(df, x='Date', y='Average', title='NEAR Price per Day', log_y=False)
fig = px.line(df, x='Date', y='Minimum', title='NEAR Price per Day', log_y=False)
